        ...
        try {
          ...
          [...videoElements, ...canvasElements].forEach(element => {
            try {
              ...
              console.warn('⚠️ [QRScanner] Error removing element:', err);
            }
          });
          
          containerRef.current.innerHTML = '';
          console.log('✅ [QRScanner] Container cleared');
        } catch (err) {
          console.warn('⚠️ [QRScanner] Container cleanup error (ignored):', err);
        }
      }
